...
4. Pushněte změny do větve `main`.
...
## Blog
- Blog používá data ze souboru `assets/blog/posts.json`.
- Obsah článků se načítá skriptem `assets/js/blog.js`.


## Automatická kontrola webu (CI)
- Workflow `.github/workflows/validate-site.yml` při push/PR spouští `tools/check_site.py`.
- Kontroluje interní odkazy, existenci assetů, validitu JSON a konzistenci navigace.
